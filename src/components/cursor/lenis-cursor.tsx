  ...
  return (
    <div className="fixed top-0 left-0 z-50 w-full h-screen overflow-hidden pointer-events-none">
      <div ref={cursor}>
        <div
          className={cn(
            "hidden md:block absolute size-10 border border-black/10 dark:border-white/30 bg-transparent rounded-full backdrop-blur-[3px]  -translate-x-2/4 -translate-y-2/4",
            { "scale-50 ": isPointer },
          )}
        />
      </div>
